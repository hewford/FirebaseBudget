...
export class ExpenseListItem extends Component {
  ...
  componentDidMount() {
    ...
    render() {
      ...
      // const deleteButton = (
      //     <i onTouchStart={this.goToTransactions} id="view-transactions-icon" className="material-icons test_deposit">delete</i>
      // );
          ...
          <div className={'card white'}>
            <div className={'card-content black-text'}>
              ...
              <p className={'delete_options'}>
                <span className={'bold delete_yes'} onClick={this.handleDelete}>Yes</span >
                <span className={'bold delete_no'} onClick={this.handleCancel}>No</span>
              </p>
            </div>
          </div>
        );
      ...
      return (
        <div className={'card white'} onClick={this.handleClick} onTouchEnd={this.handleMouseUp} onTouchMove={this.handleTouchMove} onTouchStart={this.handleMouseDown}>
          <div className={'card-content black-text'}>
